...
# Coordinate
# Convenzione: Positivo = Nord / Est, Negativo = Sud / Ovest
LAT_DEG = 40.893
LON_DEG = 14.188
RAD = math.pi / 180

# --- CALCOLO DINAMICO DIREZIONI  ---
# Determina se N/S e E/W in base al segno delle coordinate
dir_lat = "North" if LAT_DEG >= 0 else "South"
dir_lon = "East" if LON_DEG >= 0 else "West"

# Usiamo abs() per passare numeri positivi all'URL, gestendo il segno con ns/ew
...
# URL LOCALE CORRETTO (Usa le direzioni calcolate)
